namespace YGO_Designer
{
    partial class FormDeckStrategique
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gbGenerateDeck.Controls.Add(this.label2);
			this.gbGenerateDeck.Controls.Add(this.tbNo);
			...
			this.btGenererAleatoire.Location = new System.Drawing.Point(788, 226);
			...
			// tbNo
			// 
			this.tbNo.Location = new System.Drawing.Point(788, 189);
			this.tbNo.Name = "tbNo";
			this.tbNo.Size = new System.Drawing.Size(147, 31);
			this.tbNo.TabIndex = 5;
			// 
			// label2
			// 
			this.label2.AutoSize = true;
			this.label2.Location = new System.Drawing.Point(698, 197);
