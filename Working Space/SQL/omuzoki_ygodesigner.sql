...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 06, 2020 at 05:27 PM
...
CREATE TABLE IF NOT EXISTS `combo` (
  ...
  `CODE_STRAT` char(12) DEFAULT NULL,
  `POIDS` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`CODE_EFFET`,`CODE_EFFET_1`),
...
CREATE TABLE IF NOT EXISTS `strategie` (
  ...
  `RATIO_STARTER` decimal(2,2) DEFAULT NULL,
  `RATIO_EXTENDER` decimal(2,2) DEFAULT NULL,
  `RATIO_HANTRAP` decimal(2,2) DEFAULT NULL,
